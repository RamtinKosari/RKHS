...
export default function FileManagerPage() {
  ...
  const getFileSizeBytes = (f: FileItem) => {
    ...
    // Fallback parsing from string size like "15 MB" or "45 KB"
    if (!f.size) return 0
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 items-start">
          ...
          <Card className="border-zinc-200 dark:border-zinc-800 bg-white dark:bg-zinc-900 sticky top-6">
            ...
            <CardContent className="space-y-4">
              {selectedFile ? (
                <>
                  <div className="w-full h-48 bg-zinc-50 dark:bg-zinc-950 rounded-lg border border-zinc-200 dark:border-zinc-800 flex flex-col items-center justify-center overflow-hidden relative">
